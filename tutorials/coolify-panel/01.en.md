...
This guide walks you through setting up Coolify on a **Hetzner Cloud** server running **Ubuntu 24.04**.
...
* A **Hetzner Cloud server** running **Ubuntu 24.04**
* **Root** or **sudo** access
* A **registered domain name** pointing to your Hetzner server’s IP address
...
Run the following command on your Hetzner server:
...
You have successfully installed and configured **Coolify on Hetzner Cloud (Ubuntu 24.04)**!
